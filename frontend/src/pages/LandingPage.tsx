...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-yellow-400 selection:text-black font-sans overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-zinc-400">
              Trusted by <span className="text-white">11,000+</span> Community
              Members
            </span>
          </motion.div>
          ...
          >
            Launch in <span className="text-yellow-400">Two</span> <br />{" "}
            Minutes.
          </motion.h1>

          <motion.p className="mt-6 md:mt-8 text-zinc-500 max-w-xl mx-auto font-bold text-sm md:text-lg uppercase tracking-tight px-4">
            The world's fastest store engine. No complex setups. No coding. Just
            results.
          </motion.p>
          ...
          <motion.div className="mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 px-6">
            ...
            <button
              onClick={() =>
                window.open("https://youtube.com/@sabihop36", "_blank")
              }
      ...
      {/* --- VIDEODEMO SECTION --- */}
      <section id="demo-video" className="pb-20 px-4 md:px-6 max-w-4xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="w-full bg-zinc-900 border border-zinc-800 p-2 md:p-3 rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden"
        >
          <div className="w-full aspect-video rounded-[1rem] md:rounded-[2rem] overflow-hidden bg-black">
            <iframe
              className="w-full h-full object-cover"
           src="https://www.youtube.com/embed/FeHd2wP-YfM" // Updated to the correct embed URL path
              //src="https://youtu.be/FeHd2wP-YfM?si=eTaTI3NHFxV7i-W1" // Replace with your YouTube Video ID
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
          {[
            ...
            <div key={i} className="text-center">
              <h4 className="text-4xl md:text-5xl font-black text-yellow-400 mb-1">
                {stat.val}
              </h4>
      ...
      <section className="py-20 md:py-32 px-4 md:px-6">
        <div className="max-w-6xl mx-auto mb-12 md:mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div className="text-left">
            ...
            <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] md:text-xs mt-2">
              Responsive full-page architecture.
            </p>
          </div>
          <button
            onClick={goToDashboard}
          ...
          {templates.map((temp, i) => (
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 flex justify-between items-center">
                <span className="font-black uppercase italic tracking-tight text-base md:text-lg">
                  {temp.name}
                </span>
                <button
                  onClick={goToDashboard}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          <div className="md:col-span-2 p-8 md:p-12 bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] md:rounded-[3rem] flex flex-col justify-end min-h-[250px] md:min-h-[350px]">
            ...
            <p className="text-zinc-500 text-sm md:text-base font-medium mt-2">
              Connect your brand identity to a custom URL instantly.
            </p>
          </div>
          <div className="p-8 md:p-12 bg-yellow-400 text-black rounded-[2.5rem] md:rounded-[3rem] flex flex-col justify-end min-h-[250px] md:min-h-[350px]">
            ...
            <p className="font-bold text-sm md:text-base mt-2">
              SSL protection and secure manual payments as standard.
            </p>
          </div>
        </div>
      </section>
